...
# -= Resources =-
#
#SBATCH --job-name=Pong_originalRND_NoSSL_VitRegularLucidrain_exp1_7day_batchjob
#SBATCH --nodes=1
...
torchrun --nnodes 1 --nproc_per_node 1 --standalone main.py --train --num_env_per_process 64 --config_path=./configs/exp02/Pong/config_originalRND_NoSSL_VitRegularLucidrain_pong.conf --log_name=pong_originalRND_NoSSL_VitRegularLucidrain_exp1 --save_model_path=checkpoints/exp02/Pong/pong_originalRND_NoSSL_VitRegularLucidrain_exp1.ckpt --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8

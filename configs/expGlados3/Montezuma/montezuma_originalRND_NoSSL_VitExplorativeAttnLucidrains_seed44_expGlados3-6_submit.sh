#!/bin/bash 
# --job-name=Montezuma_originalRND_NoSSL_VitExplorativeAttnLucidrains_seed44_expGlados3-6_7day_batchjob
...
torchrun --nnodes 1 --nproc_per_node 1 --rdzv-backend=c10d --rdzv-endpoint=127.0.0.1:0 --rdzv-id=36 main.py --train --num_env_per_process 64 --config_path=./configs/expGlados3/Montezuma/config_originalRND_NoSSL_VitExplorativeAttnLucidrains.conf --log_name=montezuma_originalRND_NoSSL_VitExplorativeAttnLucidrains_seed44_expGlados3-6 --save_model_path=checkpoints/expGlados3/Montezuma/montezuma_originalRND_NoSSL_VitExplorativeAttnLucidrains_seed44_expGlados3-6.ckpt --seed=44 --gpu_id=1 --use_wandb --wandb_api_key=d012c9698bf568b1807b1cfe9ed56611311573e8